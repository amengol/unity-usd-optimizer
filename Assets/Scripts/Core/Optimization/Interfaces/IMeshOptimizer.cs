...
namespace USDOptimizer.Core.Optimization.Interfaces
{
    ...
    public interface IMeshOptimizer
    {
        ...
        Task<Mesh[]> GenerateLODsAsync(Mesh mesh, int lodLevels, float[] reductionFactors);
        ...
        Task<Mesh> SimplifyMeshAsync(Mesh mesh, int targetPolygonCount);
        ...
        Task<Mesh> OptimizeVerticesAsync(Mesh mesh);
        ...
        Task<Mesh> MergeMeshesAsync(Mesh[] meshes);
    }
} 